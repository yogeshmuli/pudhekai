        ...
        <footer id="footer" className="bg-gray-900 text-white py-12 w-full">
            <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div>
                        ...
                        <div className="flex gap-4">
                            ...
                            <a href="#" aria-label="Facebook">
                                <svg className="text-xl hover:text-primary cursor-pointer" width="24" height="24" fill="currentColor" viewBox="0 0 512 512">
                            ...
                            <a href="#" aria-label="Instagram">
                                <svg className="text-xl hover:text-primary cursor-pointer" width="24" height="24" fill="currentColor" viewBox="0 0 448 512">
                ...
                <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
                    <p>© 2024 PudheKai. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
